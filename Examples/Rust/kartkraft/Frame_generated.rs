...
pub const ENUM_MIN_VEHICLE_STATE: u8 = 0;
pub const ENUM_MAX_VEHICLE_STATE: u8 = 9;
...
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_VEHICLE_STATE:[VehicleState; 10] = [
  VehicleState::Idle,
  VehicleState::Pits,
...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_VEHICLE_STATE:[&'static str; 10] = [
    "Idle",
    "Pits",
    "PitGrid",
    "Outlap",
...
pub fn enum_name_vehicle_state(e: VehicleState) -> &'static str {
  let index = e as u8;
  ENUM_NAMES_VEHICLE_STATE[index as usize]
}
...
pub const ENUM_MAX_SURFACE: u8 = 6;
...
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_SURFACE:[Surface; 7] = [
  Surface::None,
  Surface::Asphalt,
  Surface::Grass,
  Surface::Gravel,
...
pub fn enum_name_surface(e: Surface) -> &'static str {
  let index = e as u8;
  ENUM_NAMES_SURFACE[index as usize]
}
...
impl<'a> Motion<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
      ...
      builder.add_worldPositionZ(args.worldPositionZ);
      builder.add_worldPositionY(args.worldPositionY);
      builder.add_worldPositionX(args.worldPositionX);
    ...
    pub const VT_WORLDPOSITIONX: flatbuffers::VOffsetT = 38;
    pub const VT_WORLDPOSITIONY: flatbuffers::VOffsetT = 40;
    pub const VT_WORLDPOSITIONZ: flatbuffers::VOffsetT = 42;
  ...
  #[inline]
  pub fn wheels(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Wheel<'a>>>> {
  ...
  #[inline]
  pub fn worldPositionX(&self) -> f32 {
    self._tab.get::<f32>(Motion::VT_WORLDPOSITIONX, Some(0.0)).unwrap()
  }
  #[inline]
  pub fn worldPositionY(&self) -> f32 {
    self._tab.get::<f32>(Motion::VT_WORLDPOSITIONY, Some(0.0)).unwrap()
  }
  #[inline]
  pub fn worldPositionZ(&self) -> f32 {
    self._tab.get::<f32>(Motion::VT_WORLDPOSITIONZ, Some(0.0)).unwrap()
  }
}
...
pub struct MotionArgs<'a> {
    ...
    pub worldPositionX: f32,
    pub worldPositionY: f32,
    pub worldPositionZ: f32,
}
...
impl<'a: 'b, 'b> MotionBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_worldPositionX(&mut self, worldPositionX: f32) {
    self.fbb_.push_slot::<f32>(Motion::VT_WORLDPOSITIONX, worldPositionX, 0.0);
  }
  #[inline]
  pub fn add_worldPositionY(&mut self, worldPositionY: f32) {
    self.fbb_.push_slot::<f32>(Motion::VT_WORLDPOSITIONY, worldPositionY, 0.0);
  }
  #[inline]
  pub fn add_worldPositionZ(&mut self, worldPositionZ: f32) {
    self.fbb_.push_slot::<f32>(Motion::VT_WORLDPOSITIONZ, worldPositionZ, 0.0);
  }
  #[inline]
...
impl<'a> Session<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
      ...
      builder.add_timeElapsed(args.timeElapsed);
      if let Some(x) = args.vehicles { builder.add_vehicles(x); }
      builder.finish()
    }

    pub const VT_VEHICLES: flatbuffers::VOffsetT = 10;
    pub const VT_TIMEELAPSED: flatbuffers::VOffsetT = 12;

  #[inline]
  pub fn vehicles(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Vehicle<'a>>>> {
  ...
  #[inline]
  pub fn timeElapsed(&self) -> f32 {
    self._tab.get::<f32>(Session::VT_TIMEELAPSED, Some(0.0)).unwrap()
  }
}
...
impl<'a: 'b, 'b> SessionBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_timeElapsed(&mut self, timeElapsed: f32) {
    self.fbb_.push_slot::<f32>(Session::VT_TIMEELAPSED, timeElapsed, 0.0);
  }
  #[inline]
...
impl<'a> TrackConfig<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
      ...
      builder.add_trackLengthMetres(args.trackLengthMetres);
    ...
    pub const VT_TRACKLENGTHMETRES: flatbuffers::VOffsetT = 8;
    pub const VT_ADDRESS: flatbuffers::VOffsetT = 10;
    pub const VT_COUNTRYCODE: flatbuffers::VOffsetT = 12;
  ...
  #[inline]
  pub fn trackLengthMetres(&self) -> f32 {
    self._tab.get::<f32>(TrackConfig::VT_TRACKLENGTHMETRES, Some(0.0)).unwrap()
  }
  #[inline]
  pub fn address(&self) -> Option<&'a str> {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(TrackConfig::VT_ADDRESS, None)
  }
  #[inline]
  pub fn countryCode(&self) -> Option<&'a str> {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(TrackConfig::VT_COUNTRYCODE, None)
  }
}
...
impl<'a: 'b, 'b> TrackConfigBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_trackLengthMetres(&mut self, trackLengthMetres: f32) {
    self.fbb_.push_slot::<f32>(TrackConfig::VT_TRACKLENGTHMETRES, trackLengthMetres, 0.0);
  }
  #[inline]
  pub fn add_address(&mut self, address: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TrackConfig::VT_ADDRESS, address);
  }
  #[inline]
  pub fn add_countryCode(&mut self, countryCode: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TrackConfig::VT_COUNTRYCODE, countryCode);
  }
  #[inline]
...
impl<'a> SessionConfig<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args SessionConfigArgs<'args>) -> flatbuffers::WIPOffset<SessionConfig<'bldr>> {
      let mut builder = SessionConfigBuilder::new(_fbb);
      builder.add_lapLimit(args.lapLimit);
      builder.add_timeLimit(args.timeLimit);
      if let Some(x) = args.name { builder.add_name(x); }
      builder.finish()
    }

    pub const VT_NAME: flatbuffers::VOffsetT = 4;
    pub const VT_TIMELIMIT: flatbuffers::VOffsetT = 6;
    pub const VT_LAPLIMIT: flatbuffers::VOffsetT = 8;

  #[inline]
  pub fn name(&self) -> Option<&'a str> {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(SessionConfig::VT_NAME, None)
  }
  #[inline]
  pub fn timeLimit(&self) -> u32 {
    self._tab.get::<u32>(SessionConfig::VT_TIMELIMIT, Some(0)).unwrap()
  }
  #[inline]
  pub fn lapLimit(&self) -> u32 {
    self._tab.get::<u32>(SessionConfig::VT_LAPLIMIT, Some(0)).unwrap()
  }
}

pub struct SessionConfigArgs<'a> {
    pub name: Option<flatbuffers::WIPOffset<&'a  str>>,
    pub timeLimit: u32,
    pub lapLimit: u32,
}
impl<'a> Default for SessionConfigArgs<'a> {
    #[inline]
    fn default() -> Self {
        SessionConfigArgs {
            name: None,
...
pub struct SessionConfigBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> SessionConfigBuilder<'a, 'b> {
  #[inline]
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SessionConfig::VT_NAME, name);
  }
  #[inline]
  pub fn add_timeLimit(&mut self, timeLimit: u32) {
    self.fbb_.push_slot::<u32>(SessionConfig::VT_TIMELIMIT, timeLimit, 0);
  }
  #[inline]
  pub fn add_lapLimit(&mut self, lapLimit: u32) {
    self.fbb_.push_slot::<u32>(SessionConfig::VT_LAPLIMIT, lapLimit, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> SessionConfigBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl<'a> Frame<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
      ...
      if let Some(x) = args.sessionConfig { builder.add_sessionConfig(x); }
    ...
    pub const VT_SESSIONCONFIG: flatbuffers::VOffsetT = 16;
  ...
  #[inline]
  pub fn sessionConfig(&self) -> Option<SessionConfig<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<SessionConfig<'a>>>(Frame::VT_SESSIONCONFIG, None)
  }
}
...
pub struct FrameArgs<'a> {
    ...
    pub sessionConfig: Option<flatbuffers::WIPOffset<SessionConfig<'a >>>,
}
...
impl<'a: 'b, 'b> FrameBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_sessionConfig(&mut self, sessionConfig: flatbuffers::WIPOffset<SessionConfig<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<SessionConfig>>(Frame::VT_SESSIONCONFIG, sessionConfig);
  }
  #[inline]
