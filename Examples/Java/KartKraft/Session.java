...
public final class Session extends Table {
  ...
  public int totalTime() { int o = __offset(6); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  public int timeLeft() { int o = __offset(8); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  public int totalLaps() { int o = __offset(10); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  public Vehicle vehicles(int j) { return vehicles(new Vehicle(), j); }
  public Vehicle vehicles(Vehicle obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int vehiclesLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  ...
  public static void addVehicles(FlatBufferBuilder builder, int vehiclesOffset) { builder.addOffset(4, vehiclesOffset, 0); }
